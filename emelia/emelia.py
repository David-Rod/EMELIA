...
# one_hot_encode(create_id_label_feature_list,)
# enc = OneHotEncoder(handle_unknown='ignore')
# x = create_id_label_feature_list()
# print(enc.fit(x))

# labelendcoder = LabelEncoder()
# x[2] = labelendcoder.fit_transform(x[2])
# print(x)

# print(create_id_label_feature_list())
# one_hot_encode(create_id_label_feature_list())
# write_to_file(make_incident_id_to_alarm_hex_list())
write_to_file(create_id_label_feature_list(), 'result_file.txt')
# write_to_file(,'one_hot.txt')
