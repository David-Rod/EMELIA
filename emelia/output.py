...
def main():
    ...
    classify_data(encoded_hex_codes, event_cause_options, 'event_cause_weights.hdf5')
    ...
    with open('result.csv', mode='w') as csv_file:
           ...
           for rows in range(length_of_array):
                  ...
                  # if the index of largest confidence value equals the index of actual classification 
